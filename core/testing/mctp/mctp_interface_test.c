	...
	int issue_request_status, uint8_t msg_type)
{
	...
	printf("Inside mctp_interface_testing_generate_and_issue_request, status is %d\n", status);
}
...
static void mctp_understanding(CuTest *test){
	struct mctp_interface_testing mctp;
 	uint8_t buf[MCTP_BASE_PROTOCOL_MAX_MESSAGE_BODY] = {0,1,2};
 	uint8_t msg_buf[MCTP_BASE_PROTOCOL_MAX_MESSAGE_LEN] = {0};
	int status;
	...
	status = mctp_interface_issue_request (&mctp.mctp, &mctp.channel.base, 0x77, 0xFF, buf,
		sizeof (buf), msg_buf, sizeof (msg_buf), 100);
	//2130712078 is value of status which corresponds to MCTP_BASE_PROTOCOL_RESPONSE_TIMEOUT
	printf("My test worked??\n");
	printf("Value of status is %d\n", status);
	// printf("invalid_argument has value of %d\n", MCTP_BASE_PROTOCOL_INVALID_ARGUMENT);
	// printf("MCTP_BASE_PROTOCOL_NO_MEMORY has value of %d\n", MCTP_BASE_PROTOCOL_NO_MEMORY);
	// printf("MCTP_BASE_PROTOCOL_NO_SOM has value of %d\n", MCTP_BASE_PROTOCOL_NO_SOM);
	// printf("MCTP_BASE_PROTOCOL_UNEXPECTED_PKT has value of %d\n", MCTP_BASE_PROTOCOL_UNEXPECTED_PKT);
	// printf("MCTP_BASE_PROTOCOL_BAD_LENGTH has value of %d\n", MCTP_BASE_PROTOCOL_BAD_LENGTH);
	// printf("MCTP_BASE_PROTOCOL_MSG_TOO_LARGE has value of %d\n", MCTP_BASE_PROTOCOL_MSG_TOO_LARGE);
	// printf("MCTP_BASE_PROTOCOL_INVALID_MSG has value of %d\n", MCTP_BASE_PROTOCOL_INVALID_MSG);
	// printf("MCTP_BASE_PROTOCOL_BAD_CHECKSUM has value of %d\n", MCTP_BASE_PROTOCOL_BAD_CHECKSUM);
	// printf("MCTP_BASE_PROTOCOL_MSG_TOO_SHORT has value of %d\n", MCTP_BASE_PROTOCOL_MSG_TOO_SHORT);
	// printf("MCTP_BASE_PROTOCOL_BAD_BUFFER_LENGTH has value of %d\n", MCTP_BASE_PROTOCOL_BAD_BUFFER_LENGTH);
	// printf("MCTP_BASE_PROTOCOL_BUF_TOO_SMALL has value of %d\n", MCTP_BASE_PROTOCOL_BUF_TOO_SMALL);
	// printf("MCTP_BASE_PROTOCOL_UNSUPPORTED_MSG has value of %d\n", MCTP_BASE_PROTOCOL_UNSUPPORTED_MSG);
	// printf("MCTP_BASE_PROTOCOL_INVALID_EID has value of %d\n", MCTP_BASE_PROTOCOL_INVALID_EID);
	// printf("MCTP_BASE_PROTOCOL_BUILD_UNSUPPORTED has value of %d\n", MCTP_BASE_PROTOCOL_BUILD_UNSUPPORTED);
	// printf("MCTP_BASE_PROTOCOL_RESPONSE_TIMEOUT has value of %d\n", MCTP_BASE_PROTOCOL_RESPONSE_TIMEOUT);
	CuAssertIntEquals (test, MCTP_BASE_PROTOCOL_MSG_TOO_LARGE, status);
...
static void mctp_learning_2(CuTest *test){
	struct mctp_interface_testing mctp;
	struct mctp_interface_test_callback_context context;
	struct cmd_packet rx;
	struct mctp_base_protocol_transport_header *header =
...
// static void learning3(CuTest *test){
// 	struct mctp_interface_testing mctp;
// 	struct cmd_packet rx;
// 	struct cmd_message *tx;
// 	struct mctp_base_protocol_transport_header *header =
...
// 	CuAssertIntEquals (test, 0, status);
// 	printf("Is PTR null?\n");
// 	printf("0 is false, 1 is true (want it to be 0) %d\n", tx == NULL);
// 	printf("sizeof tx is %d\n", tx->msg_size);
// 	int sock = pit_connect(5600);
// 	send(sock, tx, tx->msg_size, 0);
...
TEST (mctp_understanding);
TEST (mctp_learning_2);
// TEST (learning3);
